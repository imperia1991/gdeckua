...
//                )
		...
		'urlManager'   => [
			...
			'rules'          => [
				...
				'<language:(ru|uk)>/<module:(user)>'                               => '<module>/user/index',
				'<language:(ru|uk)>/<module:(user)>/<controller:\w+>/<action:\w+>' => '<module>/<controller>/<action>',
				'<language:(ru|uk)>/<module:(user)>/<controller:(blog)>'              => '<module>/<controller>/index',
				'<language:(ru|uk)>/<module:(user)>/<action:\w+>'                  => '<module>/user/<action>',
				'<language:(ru|uk)>/'                                              => 'place/index',
				'<language:(ru|uk)>/main'                                          => 'site/index',
				'<language:(ru|uk)>/page/<page:\d+>'                               => 'place/index',
				...
				'<language:(ru|uk)>/user/<action:\w+>'                             => 'user/<action>',
				...
				'<language:(ru|uk)>/<controller:(user)>'                           => 'user/index',
