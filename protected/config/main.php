...
//                )
		...
		'urlManager'   => [
			...
			'rules'          => [
				...
				'<language:(ru|uk)><module:(user)>'                               => '<module>/default/index',
				'<language:(ru|uk)><module:(user)>/<controller:\w+>'              => '<module>/<controller>/index',
				...
				'<language:(ru|uk)>/muser/<action:\w+>'                           => 'muser/<action>',
				...
				'<language:(ru|uk)>/<controller:(muser)>'                         => 'muser/index',
