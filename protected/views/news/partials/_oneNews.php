...
<div class="large-2 medium-2 columns">
    <?php
    echo Yii::app()->easyImage->thumbOf('/' . Yii::app()->params['admin']['files']['news'] . '/' . $data->photo,
        [
...
<div class="large-10 medium-10 columns new-description">
    <div class="row title-new">
        <div class="large-9 medium-9 columns">
            <a href="<?php echo Yii::app()->createUrl('/' . Yii::app()->getLanguage() . '/news/' . $data->id . '/' . $data->alias); ?>">
    ...
    <div class="large-12 columns new-preview-text">
        ...
        <p class="right">
            <a href="<?php echo Yii::app()->createUrl('/' . Yii::app()->getLanguage() . '/news/' . $data->id . '/' . $data->alias); ?>"><?php echo Yii::t('main', 'показать новость полностью'); ?></a>
        </p>
    </div>
</div>