        ...
        <div class="large-12 columns left-sector-news-box">
            <div class="row left-sector-news-title collapse">
                <div class="large-2 medium-2 columns">
                    ...
                    <p>
                        <?php echo Yii::t('main', '{date} в {time}', [
                                '{date}' => Yii::app()->dateFormatter->format('dd.MM.yyyy', $currentNewsModel->created_at),
                                '{time}' => Yii::app()->dateFormatter->format('HH:mm', $currentNewsModel->created_at)
                            ]); ?>
                    </p>
                </div>
    ...
    <div class="row news-box-switcher">
        <div class="large-6 medium-6 columns">
            <?php if ($prevNewsModel): ?>
                <p class="left">
                    <a href="<?php echo Yii::app()->createUrl('/' . Yii::app()->getLanguage() . '/news/' . $prevNewsModel->id . '/' . $prevNewsModel->alias) ?>">
        ...
        <div class="large-6 medium-6 columns">
            <?php if ($nextNewsModel): ?>
                <p class="right">
                    <a href="<?php echo Yii::app()->createUrl('/' . Yii::app()->getLanguage() . '/news/' . $nextNewsModel->id . '/' . $nextNewsModel->alias) ?>">
