...
<!--        <div class="large-12 columns foto-inner-title"><h3>--><?php //echo $data->title; ?><!--</h3></div>-->
        <div class="large-12 columns foto-inner-img view view-first">
...
<!--                <span class="enlarge large-lupa">--><?php //echo Yii::t('main', 'Увеличить'); ?><!--&nbsp;<img src="/img/lupka.png"></span>-->
            ...
            <div class="mask">
                ...
                <p><?php echo Yii::t('main', 'фото'); ?>: <?php echo $data->author; ?></p>
                <a href="<?php
                ...
                ?>"
                   class="info gallery" title="<?php echo $data->title; ?>"><?php echo Yii::t('main', 'Увеличить'); ?></a>
            </div>
        </div>
