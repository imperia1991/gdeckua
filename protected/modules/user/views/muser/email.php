...
<div class="page_content news clearfix">
	<div class="news_main muser">
		...
		<div class="add_object">
			...
			<div class="form_input_wrap">
				<div class="form_input_label" style="font-size: 20px">
					<?php echo Yii::t('main', 'Ваш новый E-Mail'); ?> <span class="nes">*</span>
				</div>
				<div class="input_wrap ">
					<?php echo $form->textField($modelChangeEmailForm, 'newEmail', [
						'class' => 'input'
					]); ?>
					<?php if (isset($errors['newEmail'])): ?>
						<span class="input_error"><?php echo $errors['newEmail'][0]; ?></span>
					<?php endif; ?>
				</div>
			</div>
			<div class="form_input_wrap">
				<div class="form_input_label" style="font-size: 18px">
					<?php echo Yii::t('main', 'Повторите новый E-Mail'); ?> <span class="nes">*</span>
				</div>
				<div class="input_wrap ">
					<?php echo $form->textField($modelChangeEmailForm, 'newEmailRepeat', [
						'class' => 'input'
					]); ?>
					<?php if (isset($errors['newEmailRepeat'])): ?>
						<span class="input_error"><?php echo $errors['newEmailRepeat'][0]; ?></span>
					<?php endif; ?>
				</div>
			</div>
