...
<div class="row">
    ...
    <label class="control-label required" style="width: auto"><?php echo Yii::t('main', 'Фото для афишы (Фото желательно 491х340, иначе оно будет мутным)') ?> <span class="required">*</span></label>
    <br/><br/>
    <img id="itemPhoto" width="71" height="60" alt="" src="<?php echo $posterPhoto; ?>" style="margin-bottom: 20px;margin-top: 20px;" />
...
<div class="form-actions">
    <?php $this->widget('bootstrap.widgets.TbButton', ['buttonType'=>'submit', 'type'=>'primary', 'label'=>$posterModel->isNewRecord ? 'Добавить' : 'Сохранить']); ?>
    <?php $this->widget('bootstrap.widgets.TbButton', ['buttonType'=>'link', 'url' => '/admin/posters', 'label'=>'Отмена']); ?>
</div>
