...
<div class="form-actions">
    <?php $this->widget('bootstrap.widgets.TbButton', ['buttonType'=>'submit', 'type'=>'primary', 'label'=>$clubModel->isNewRecord ? Yii::t('admin', 'Добавить') : Yii::t('admin', 'Сохранить')]); ?>
    <?php $this->widget('bootstrap.widgets.TbButton', ['buttonType'=>'link', 'url' => '/admin/meeting', 'label'=>Yii::t('admin', 'Отмена')]); ?>
</div>
