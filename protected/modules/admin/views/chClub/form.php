...
$form = $this->beginWidget('bootstrap.widgets.TbActiveForm', [
	...
	<div class="row">
		...
		$this->widget('ImperaviRedactorWidget', [
			...
			'options'   => [
				'lang'               => $lang,
				'minHeight'          => 200,
				'imageGetJson'       => Yii::app()->createAbsoluteUrl('/admin/chClub/imageGetJson'),
				'imageUpload'        => Yii::app()->createAbsoluteUrl('/admin/chClub/imageUpload'),
				'clipboardUploadUrl' => Yii::app()->createAbsoluteUrl('/admin/chClub/imageUpload'),
	...
	<div class="row" style="margin-bottom: 30px;">
		...
		$this->widget('ext.EAjaxUpload.EAjaxUpload', [
				'id'     => 'uploadPhotos',
				'config' => [
					'action'            => Yii::app()->createUrl('/admin/chClub/uploadPhotos'),
