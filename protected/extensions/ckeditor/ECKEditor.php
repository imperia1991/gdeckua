...
//		$_SESSION['KCFINDER']['uploadDir'] = $_SERVER['DOCUMENT_ROOT']."/uploads/"; // path to the uploads folde
        $_SESSION['KCFINDER']['uploadURL'] = '/' . Yii::app()->params['admin']['files']['news']; // URL for the uploads folder
		$_SESSION['KCFINDER']['uploadDir'] = $_SERVER['DOCUMENT_ROOT'] . '/' . Yii::app()->params['admin']['files']['news']; // path to the uploads folder
