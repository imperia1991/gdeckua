...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        function n(e) {
            this.walk = function (t, n) {
                ...
                function r(r) {
                    ...
                    function l(n, r) {
                        var a, s, l;
                        if (r = r || c, l = e.getParent(r.parentNode, e.isBlock) || f, n && "BR" == r.nodeName && v && e.isEmpty(l))return c = r.parentNode, d = e.nodeIndex(r), void(i = !0);
                    ...
                    var c, d, u, f = e.getRoot(), p, m, h, g, v;
                    if (c = n[(r ? "start" : "end") + "Container"], d = n[(r ? "start" : "end") + "Offset"], v = 1 == c.nodeType && d === c.childNodes.length, m = e.schema.getNonEmptyElements(), g = r, 1 == c.nodeType && d > c.childNodes.length - 1 && (g = !1), 9 === c.nodeType && (c = e.getRoot(), d = 0), c === f) {
                        if (g && (p = c.childNodes[d > 0 ? d - 1 : 0], p && (h = p.nodeName.toLowerCase(), m[p.nodeName] || "TABLE" == p.nodeName)))return;
                        if (c.hasChildNodes() && (d = Math.min(!g && d > 0 ? d - 1 : d, c.childNodes.length - 1), c = c.childNodes[d], d = 0, c.hasChildNodes() && !/TABLE/.test(c.nodeName))) {
                            p = c, u = new t(c, f);
                            do {
                                if (3 === p.nodeType && p.nodeValue.length > 0) {
                                    d = g ? 0 : p.nodeValue.length, c = p, i = !0;
                                    break
                                }
                                if (m[p.nodeName.toLowerCase()]) {
                                    d = e.nodeIndex(p), c = p.parentNode, "IMG" != p.nodeName || g || d++, i = !0;
                                    break
                                }
                            } while (p = g ? u.next() : u.prev())
                        }
                    }
                    o && (3 === c.nodeType && 0 === d && l(!0), 1 === c.nodeType && (p = c.childNodes[d], p || (p = c.childNodes[d - 1]), !p || "BR" !== p.nodeName || s(p, "A") || a(p) || a(p, !0) || l(!0, p))), g && !o && 3 === c.nodeType && d === c.nodeValue.length && l(!1), i && n["set" + (r ? "Start" : "End")](c, d)
                }
        ...
        return function (r) {
            ...
            function p(t, n, o) {
                ...
                if (h)if (o)o.nodeType ? (y = I.createRng(), y.setStartBefore(o), y.setEndAfter(o), u(T(y, m), null, !0)) : u(o, null, !0); else if (b && h.inline && !I.select("td.mce-item-selected,th.mce-item-selected").length)H("apply", t, n); else {
            ...
            function m(e, t, n) {
                ...
                return n ? void(n.nodeType ? (y = I.createRng(), y.setStartBefore(n), y.setEndAfter(n), f(y)) : f(n)) : void(F.isCollapsed() && m.inline && !I.select("td.mce-item-selected,th.mce-item-selected").length ? H("remove", e, t) : (h = F.getBookmark(), f(F.getRng(Y)), F.moveToBookmark(h), m.inline && v(e, t, F.getStart()) && P(F.getRng(!0)), r.nodeChanged()))
            }
            ...
            function D(e, t) {
                function n(e, t) {
                    ...
                    return e.nodeName != t.nodeName ? K : r(n(e), n(t)) ? r(I.parseStyle(I.getAttrib(e, "style")), I.parseStyle(I.getAttrib(t, "style"))) ? !L(e) && !L(t) : K : K
                }
        ...
        return function (i) {
            function o(o) {
                ...
                if (k = s.getRng(!0), !o.isDefaultPrevented()) {
                    ...
                    if (new t(a).normalize(k), R = k.startContainer, A = k.startOffset, F = (l.force_p_newlines ? "br" : "") || l.forced_root_block, F = F ? F.toUpperCase() : "", L = a.doc.documentMode, D = o.shiftKey, 1 == R.nodeType && R.hasChildNodes() && (z = A > R.childNodes.length - 1, R = R.childNodes[Math.min(A, R.childNodes.length - 1)] || R, A = z && 3 == R.nodeType ? R.nodeValue.length : 0), T = N(R)) {
    ...
    }), r(j, [V, z, F, U, q, f, W], function (e, t, n, r, i, o, a) {
        var s = {};
    ...
    }), r(tt, [T, A, C, m, h, f], function (e, t, n, r, i, o) {
        return function (a) {
            function s(e, t) {
                try {
    ...
    }), r(it, [v, b, C, k, E, B, L, D, M, H, P, O, y, d, et, x, _, tt, h, f, nt, rt], function (e, n, r, i, o, a, s, l, c, d, u, f, p, m, h, g, v, y, b, C, x, w) {
        function _(e, t) {
        ...
        return N.prototype = {render: function () {
            ...
            e || (o = r.getRng(), o.item && (a = o.item(0)), n._refreshContentEditable(), i || (b.opera || n.getBody().focus(), n.getWin().focus()), (H || i) && (l = n.getBody(), l.setActive && b.ie < 11 ? l.setActive() : l.focus(), i && r.normalize()), a && a.ownerDocument == s && (o = s.body.createControlRange(), o.addElement(a), o.select())), n.editorManager.activeEditor != n && ((t = n.editorManager.activeEditor) && t.fire("deactivate", {relatedTarget: n}), n.fire("activate", {relatedTarget: t})), n.editorManager.activeEditor = n
            ...
            var e = this;
            if (!e.removed) {
                e.save(), e.fire("remove"), e.off(), e.removed = 1, e.hasHiddenInput && E.remove(e.getElement().nextSibling), E.setStyle(e.id, "display", e.orgDisplay), e.settings.content_editable || (M.unbind(e.getWin()), M.unbind(e.getDoc()));
                var t = e.getContainer();
                M.unbind(e.getBody()), M.unbind(t), e.editorManager.remove(e), E.remove(t), e.destroy()
            }
        ...
        var c = n.DOM, d = o.explode, u = o.each, f = o.extend, p = 0, m, h = {majorVersion: "4", minorVersion: "0.20", releaseDate: "2014-03-18", editors: [], i18n: s, activeEditor: null, setup: function () {
            var e = this, t, n, i = "", o;
    ...
    }), r(Mt, [V, yt, J, f, st, h], function (e, t, n, r, i, o) {
        function a(e) {
            function t(t) {
                function n(e) {
    ...
    }), a([l, c, d, u, f, p, m, h, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, D, M, H, P, O, I, F, z, W, V, U, q, j, $, K, Y, G, X, J, Q, Z, et, tt, nt, rt, it, ot, at, st, lt, ct, dt, ut, ft, pt, mt, ht, gt, vt, yt, bt, Ct, xt, wt, _t, Nt, Et, kt, St, Tt, Rt, At, Bt, Lt, Dt, Mt, Ht, Pt, Ot, It, Ft, zt, Wt, Vt, Ut, qt, jt, $t, Kt, Yt, Gt, Xt, Jt])
}(this);